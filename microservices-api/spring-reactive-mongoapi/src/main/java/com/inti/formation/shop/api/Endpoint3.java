...
public class Endpoint3 {
    ...
    @PostMapping(value = "/stockinit/register" , headers = "Accept=application/json; charset=utf-8")
    ...
    public Mono<String> create(@RequestBody StockInit stockInit) {
        ...
        if( ObjectUtils.anyNotNull(stockInit)  && !ObjectUtils.allNotNull(stockInit.getDate(),stockInit.getIdproduct())){
    ...
    public Flux<StockInit> getProducts() {
